...
const Navbar = () => {
  ...
  return (
    <div className="flex item-center justify-between p-4 z-100 w-11/12 m-auto ">
      <Link to="/">
        <h1 className="text-5xl font-bold cursor-pointer hover:text-red-800">
          moviedb
        </h1>
      </Link>
      {user?.email ? (
        <div>
          ...
          <button
            ...
            className="text-[#FFFDE3] border border-gray-300 px-6 py-2 cursor-pointer hover:bg-red-800 "
          >
            Logout
          </button>
        </div>
        ...
        <div>
          ...
          <Link to="/register">
            <button className="text-[#FFFDE3] border border-gray-300 px-6 py-2 cursor-pointer hover:bg-red-800">
              Register
            </button>
          </Link>
        </div>
